...
//    JSON_ASSERT_MESSAGE(InRange(value_.real_, minInt, maxInt), "double out of Int range");
  ...
  case stringValue:
    return Int(atoi(this->asString().c_str()));
  default:
    return 0;
  }
...
//    JSON_ASSERT_MESSAGE(InRange(value_.real_, 0, maxUInt), "double out of UInt range");
  ...
  case booleanValue:
    return value_.bool_ ? 1 : 0;
  case stringValue:
    return UInt(atoi(this->asString().c_str()));
  default:
    return 0;
  }
...
//    JSON_ASSERT_MESSAGE(InRange(value_.real_, minInt64, maxInt64), "double out of Int64 range");
  ...
  case booleanValue:
    return value_.bool_ ? 1 : 0;
  case stringValue:
    return Int64(atoll(this->asString().c_str()));
  default:
    return 0;
  }
...
//    JSON_ASSERT_MESSAGE(InRange(value_.real_, 0, maxUInt64), "double out of UInt64 range");
  ...
  case booleanValue:
    return value_.bool_ ? 1 : 0;
  case stringValue:
    return UInt64(atoll(this->asString().c_str()));
  default:
    return 0;
  }
...
double Value::asDouble() const {
  ...
  case stringValue:
    return static_cast<double>(atof(this->asString().c_str()));
  default:
      return 0.0;
  }
...
float Value::asFloat() const {
  ...
  case stringValue:
    return static_cast<float>(atof(this->asString().c_str()));
  default:
      return 0.0;
  }
...
bool Value::asBool() const {
  ...
  case stringValue:
      {
        std::string strValue = this->asString();
#ifndef _WIN32
    #define stricmp strcasecmp
#endif
        return ((stricmp(strValue.c_str(), "true") == 0) || (stricmp(strValue.c_str(), "1") == 0));
      }
  default:
      return false;
  }
